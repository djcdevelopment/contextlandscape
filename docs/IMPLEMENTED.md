...
- The browser uses a phase-led Command Deck: a five-stage stepper, operation rail, persistent context,
  ...
  icon/beacon affordances and staged actions retain a dashed locked treatment.
...
- Desktop short-wide sizing is based on actual viewport height rather than board width. The layout is
  regression-tested without document overflow at a 2048×900 CSS viewport with a 340px minimum board in
  both Perspective and Tactical modes; at 390×844 the mobile board begins by 720px, with contained
